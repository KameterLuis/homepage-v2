  ...
  return (
    <div className="px-4 md:px-10 mt-20 min-h-screen mb-10">
      ...
      <p>
        ...
        dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) ist Luis
        Kameter, Schrenckstra&szlig;e, 24, 85635 H&ouml;henkirchen, Deutschland,
        Tel.: 017642943148, E-Mail: contact@luiskameter.com. Der f&uuml;r die
      ...
      <br />
      <p>
        Wir nutzen ein Content Delivery Network des folgenden Anbieters: 1&amp;1
        IONOS Internet SE, Elgendorfer Str. 57, 56410 Montabaur, Deutschland
      </p>
      <br />
      <p>
        ...
        verteilter Server schneller auszuliefern. Die Verarbeitung erfolgt zur
        Wahrung unseres berechtigten Interesses an der Verbesserung der
        Stabilit&auml;t und Funktionalit&auml;t unserer Website gem. Art. 6 Abs.
        1 lit. f DSGVO.
      </p>
      <br />
      <p>
      ...
      <p>
        ...
        1&amp;1 IONOS Internet SE, Elgendorfer Str. 57, 56410 Montabaur,
        Deutschland
      </p>
      <br />
      <p>
        ...
        verwendeten Endger&auml;ts wie die IP-Adresse und Browserinformationen,
        um sie f&uuml;r statistische Analysen des Nutzungsverhaltens auf unserer
        Website auszuwerten und pseudonymisierte Nutzungsprofile zu erstellen.
        Unter anderem ist so die Auswertung von Bewegungsmustern (sog. Heatmaps)
        m&ouml;glich, welche die Dauer von Seitenbesuchen sowie Interaktionen
        mit Seiteninhalten (z. B. Texteingaben, Scrollen, Klicks und
        Mouse-Overs) aufzeigen. Die Pseudonymisierung schlie&szlig;t eine
        direkte Personenbeziehbarkeit grunds&auml;tzlich aus. Eine
      ...
      <p>
        ...
        einschlie&szlig;lich Ihrer IP-Adresse, an den Anbieter &uuml;bermittelt.
      </p>
      <br />
      ...
      <p>
        ...
        bereitgestellte &bdquo;Cookie-Consent-Tool&#8220; deaktivieren. Falls
        Ihr Browser keine Web Fonts unterst&uuml;tzt, wird eine Standardschrift
