          ...
          <div className="flex flex-col items-center mt-12 md:mt-20 pb-24">
            <div className="text-black text-center md:mt-10 md:text-xl max-w-[500px] px-4">
              ...
              <p>
                ...
                und bedanken uns f&uuml;r Ihr Interesse. Im Folgenden
                informieren wir Sie &uuml;ber den Umgang mit Ihren
              ...
              <br />
              <p>
                <b>1.2</b>&nbsp;Verantwortlicher f&uuml;r die Datenverarbeitung
                auf dieser Website im Sinne der Datenschutz-Grundverordnung
                (DSGVO) ist Luis Kameter, Schrenckstra&szlig;e, 24, 85635
                H&ouml;henkirchen, Deutschland, Tel.: 017642943148, E-Mail:
                contact@luiskameter.com. Der f&uuml;r die Verarbeitung von
                personenbezogenen Daten Verantwortliche ist diejenige
                nat&uuml;rliche oder juristische Person, die allein oder
              ...
              <br />
              <p>
                <b>2.1</b>&nbsp;Bei der blo&szlig; informatorischen Nutzung
                unserer Website, also wenn Sie sich nicht registrieren oder uns
                anderweitig Informationen &uuml;bermitteln, erheben wir nur
                solche Daten, die Ihr Browser an den Seitenserver
                &uuml;bermittelt (sog. &bdquo;Server-Logfiles&#8220;). Wenn Sie
              ...
              <p>
                ...
                an den Verantwortlichen) eine SSL-bzw. TLS-Verschl&uuml;sselung.
                Sie k&ouml;nnen eine verschl&uuml;sselte Verbindung an der
                Zeichenfolge &bdquo;https://&#8220; und dem Schloss-Symbol in
              ...
              <p>
                ...
                werden ausschlie&szlig;lich zum Zweck der Beantwortung Ihres
                Anliegens bzw. f&uuml;r die Kontaktaufnahme und die damit
              ...
              <p>
                ...
                zus&auml;tzliche Rechtsgrundlage f&uuml;r die Verarbeitung Art.
                6 Abs. 1 lit. b DSGVO. Ihre Daten werden nach
                abschlie&szlig;ender Bearbeitung Ihrer Anfrage gel&ouml;scht.
                Dies ist der Fall, wenn sich aus den Umst&auml;nden entnehmen
                l&auml;sst, dass der betroffene Sachverhalt abschlie&szlig;end
                gekl&auml;rt ist und sofern keine gesetzlichen
              ...
              <br />
              <p>
                Diese Website nutzt den Webanalysedienst des folgenden
                Anbieters: 1&amp;1 IONOS Internet SE, Elgendorfer Str. 57, 56410
              ...
              <p>
                ...
                Endger&auml;te- und Browserinformationen) erhebt und speichert
                der Dienst pseudonymisierte Besucherdaten, darunter
                Informationen des verwendeten Endger&auml;ts wie die IP-Adresse
                und Browserinformationen, um sie f&uuml;r statistische Analysen
                des Nutzungsverhaltens auf unserer Website auszuwerten und
                pseudonymisierte Nutzungsprofile zu erstellen. Unter anderem ist
                so die Auswertung von Bewegungsmustern (sog. Heatmaps)
                m&ouml;glich, welche die Dauer von Seitenbesuchen sowie
                Interaktionen mit Seiteninhalten (z. B. Texteingaben, Scrollen,
                Klicks und Mouse-Overs) aufzeigen. Die Pseudonymisierung
                schlie&szlig;t eine direkte Personenbeziehbarkeit
                grunds&auml;tzlich aus. Eine Zusammenf&uuml;hrung mit auf andere
                Weise erhobenen Klardaten zu Ihrer Person findet nicht statt.
              </p>
              <br />
              <p>
                Alle oben beschriebenen Verarbeitungen, insbesondere das
                Auslesen oder Speichern von Informationen auf dem verwendeten
                Endger&auml;t, werden nur dann vollzogen, wenn Sie uns
                gem&auml;&szlig; Art. 6 Abs. 1 lit. a DSGVO dazu Ihre
                ausdr&uuml;ckliche Einwilligung erteilt haben. Sie k&ouml;nnen
                Ihre erteilte Einwilligung jederzeit mit Wirkung f&uuml;r die
                Zukunft widerrufen, indem Sie diesen Dienst in dem auf der
              ...
              <p>
                ...
                ben&ouml;tigten Web Fonts in ihren Browser-Cache, um Texte und
                Schriftarten korrekt anzuzeigen und stellt eine direkte
              ...
              <br />
              <p>
                Daten k&ouml;nnen zudem &uuml;bermittelt werden an: Google LLC,
                USA
              </p>
              <br />
              <p>
                ...
                dann vollzogen, wenn Sie uns gem&auml;&szlig; Art. 6 Abs. 1 lit.
                a DSGVO dazu Ihre ausdr&uuml;ckliche Einwilligung erteilt haben.
                Sie k&ouml;nnen Ihre erteilte Einwilligung jederzeit mit Wirkung
                f&uuml;r die Zukunft widerrufen, indem Sie diesen Dienst
                &uuml;ber das auf der Webseite bereitgestellte
                &bdquo;Cookie-Consent-Tool&#8220; deaktivieren. Falls Ihr
                Browser keine Web Fonts unterst&uuml;tzt, wird eine
                Standardschrift von Ihrem Computer genutzt.
              </p>
              <br />
              <p>
                F&uuml;r Daten&uuml;bermittlungen in die USA hat sich der
                Anbieter dem EU-US-Datenschutzrahmen (EU-US Data Privacy
                Framework) angeschlossen, das auf Basis eines
                Angemessenheitsbeschlusses der Europ&auml;ischen Kommission die
                Einhaltung des europ&auml;ischen
              ...
              <br />
              <p>
                <b>6.1</b>&nbsp;Das geltende Datenschutzrecht gew&auml;hrt Ihnen
                gegen&uuml;ber dem Verantwortlichen hinsichtlich der
              ...
              <ul>
                ...
                <li>
                  Recht auf Widerruf erteilter Einwilligungen gem&auml;&szlig;
                  Art. 7 Abs. 3 DSGVO;
                </li>
              ...
              <p>
                ...
                ERGEBEN, GEGEN DIESE VERARBEITUNG WIDERSPRUCH MIT WIRKUNG
                F&Uuml;R DIE ZUKUNFT EINZULEGEN.
              </p>
              <br />
              <p>
                ...
                BLEIBT ABER VORBEHALTEN, WENN WIR ZWINGENDE SCHUTZW&Uuml;RDIGE
                GR&Uuml;NDE F&Uuml;R DIE VERARBEITUNG NACHWEISEN K&Ouml;NNEN,
                DIE IHRE INTERESSEN, GRUNDRECHTE UND GRUNDFREIHEITEN
                &Uuml;BERWIEGEN, ODER WENN DIE VERARBEITUNG DER GELTENDMACHUNG,
                AUS&Uuml;BUNG ODER VERTEIDIGUNG VON RECHTSANSPR&Uuml;CHEN DIENT.
              </p>
              <br />
              <p>
              ...
              <p>
                ...
                Verarbeitungszweck und &ndash; sofern einschl&auml;gig &ndash;
                zus&auml;tzlich anhand der jeweiligen gesetzlichen
              ...
              <p>
                ...
                einer ausdr&uuml;cklichen Einwilligung gem&auml;&szlig; Art. 6
                Abs. 1 lit. a DSGVO werden die betroffenen Daten so lange
                gespeichert, bis Sie Ihre Einwilligung widerrufen.
              </p>
              <br />
              <p>
                Existieren gesetzliche Aufbewahrungsfristen f&uuml;r Daten, die
                im Rahmen rechtsgesch&auml;ftlicher bzw.
                ...
                routinem&auml;&szlig;ig gel&ouml;scht, sofern sie nicht mehr zur
              ...
              <p>
                ...
                DSGVO aus&uuml;ben, es sei denn, wir k&ouml;nnen zwingende
              ...
              <p>
                ...
                Erkl&auml;rung &uuml;ber spezifische Verarbeitungssituationen
                nichts anderes ergibt, werden gespeicherte personenbezogene
                Daten im &Uuml;brigen dann gel&ouml;scht, wenn sie f&uuml;r die
